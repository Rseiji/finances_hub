...
CREATE TABLE IF NOT EXISTS bronze.pdf_nubank_trade_events (
    uid UUID NOT NULL,
    source TEXT NOT NULL,
    endpoint TEXT NOT NULL,
    request_params JSONB NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_pdf_nubank_trade_events_source ON bronze.pdf_nubank_trade_events (source);
CREATE INDEX IF NOT EXISTS idx_pdf_nubank_trade_events_uid ON bronze.pdf_nubank_trade_events (uid);
